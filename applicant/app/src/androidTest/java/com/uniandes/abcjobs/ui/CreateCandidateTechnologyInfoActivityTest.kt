...
@LargeTest
class CreateCandidateTechnologyInfoActivityTest {

    @get:Rule
    var activityTestScenarioRule = ActivityScenarioRule(CreateCandidateTechnologyInfoActivity::class.java)

    @get:Rule
    var intentTestScenarioRule = IntentsTestRule(CreateCandidateTechnologyInfoActivity::class.java)
    ...
    fun createWithEmptyNameTest(){
        ...
        Thread.sleep(2000)
        Espresso.onView(ViewMatchers.withId(R.id.createCandidateTechnologyButton)).perform(
            ViewActions.click())
